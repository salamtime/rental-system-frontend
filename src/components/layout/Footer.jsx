      ...
      <div className="container mx-auto px-4 pt-12 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              SaharaX offers premium ATV rentals and guided desert tours for unforgettable adventures across Morocco's beautiful landscapes.
            </p>
            ...
            <address className="not-italic">
              <div className="flex items-start mb-3">
                ...
                <span className="text-gray-400">
                  123 Desert Road, Marrakech, Morocco
                </span>
              </div>
              <div className="flex items-start mb-3">
                <svg className="h-5 w-5 text-gray-400 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="pt-8 border-t border-blue-700 text-center">
          <p className="text-gray-400">
            © {currentYear} SaharaX. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
