...
export default function RentalDetails() {
  ...
  useEffect(() => {
    ...
    return () => clearInterval(interval);
  }, [rental?.started_at, rental?.rental_status]);
  ...
  const canStartRental = isPaymentSufficient() && (rental.contract_signed || !!rental.signature_url) && hasOpeningVideo;
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="hidden sm:flex gap-2">
            ...
            <Button 
              ...
              title={!hasOpeningVideo ? "Please upload opening video before signing" : (rental.contract_signed || rental.signature_url) ? "Contract already signed" : "Sign contract"}
            >
            ...
            {rental?.customer_phone && (
              <Button 
                ...
                title={!canSendWhatsApp ? "Please sign the contract before sending WhatsApp" : "Share via WhatsApp"}
              >
                  <FaWhatsapp size={18} />
      ...
      <div className="sm:hidden fixed bottom-0 left-0 right-0 bg-white border-t p-2 z-10 flex flex-col gap-2">
        ...
        <div className="flex justify-center gap-2">
          <Button 
            ...
            title={!canGenerateInvoice ? "Sign contract first" : "Print Invoice"}
          >
          ...
          <Button 
            ...
            disabled={!canSignContract}
            className="flex-1"
            title={!hasOpeningVideo ? "Upload opening video first" : (rental.contract_signed || rental.signature_url) ? "Already signed" : "Sign contract"}
          >
        ...
        <div className="flex gap-2">
            ...
            {rental?.customer_phone && (
              <Button 
                ...
                title={!canSendWhatsApp ? "Sign contract first" : "Share via WhatsApp"}
              >
                  <FaWhatsapp size={16} />
                  {isSharing ? '...' : 'Share'}
              </Button>
